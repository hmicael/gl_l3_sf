...
#[Route('/admin/room')]
class RoomControllerAdmin extends AbstractController
{
    #[Route('/', name: 'app_room_index_admin', methods: ['GET'])]
    ...
    public function new(Request $request, RoomRepository $roomRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_room_index_admin', [], Response::HTTP_SEE_OTHER);
        }
