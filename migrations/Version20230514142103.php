...
final class Version20230514142103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cours (id INT AUTO_INCREMENT NOT NULL, u_e_id INT DEFAULT NULL, name VARCHAR(15) NOT NULL, type VARCHAR(10) NOT NULL, duration INT NOT NULL, position INT NOT NULL, INDEX IDX_FDCA8C9CC5967ED8 (u_e_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
